import { GMAIL_COMPOSE_URL, LINKEDIN_PROFILE_URL } from "../data/content";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto space-y-16 relative z-10">
        ...
        {/* Client Details Collection Section */}
        <div className="pt-16 border-t border-on-primary-container/30 mt-16">
